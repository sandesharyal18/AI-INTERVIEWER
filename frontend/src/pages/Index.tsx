...
<div className="bg-gray-50 py-16">
  <div className="max-w-6xl mx-auto text-center px-4">
    ...
    <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
      Our platform has helped hundreds of students improve their interview skills and land their dream jobs.
    </p>
    ...
    <div className="flex flex-col md:flex-row justify-center gap-8">
      ...
      {/* Card 1 */}
      <div className="bg-white p-6 rounded-2xl shadow-md max-w-sm hover:scale-105 hover:-translate-y-2 transition-transform duration-300">
        <div className="text-yellow-400 mb-3 text-xl">★★★★★</div>
        <p className="text-gray-700 mb-6">
          “This platform helped me gain confidence and practice real interview scenarios. Highly recommended!”
        </p>
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <h4 className="font-semibold">Bijay Dhakal</h4>
            <p className="text-sm text-gray-500">BSc.CSIT, 7th Semester</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md max-w-sm hover:scale-105 hover:-translate-y-2 transition-transform duration-300">
        <div className="text-yellow-400 mb-3 text-xl">★★★★★</div>
        <p className="text-gray-700 mb-6">
          “I loved the questions generated by this Web Application. My answers improved drastically after practicing here.”
        </p>
        <div className="flex items-center gap-4">
          <img
            src="/Bibek.png"
          ...
          />
          <div className="text-left">
            <h4 className="font-semibold">Bibek Pandey</h4>
            <p className="text-sm text-gray-500">BSc.CSIT, 7th Semester</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md max-w-sm hover:scale-105 hover:-translate-y-2 transition-transform duration-300">
        <div className="text-yellow-400 mb-3 text-xl">★★★★★</div>
        <p className="text-gray-700 mb-6">
          “The detailed feedback in this AI Interviewer Application helped me understand my weak points and prepare better.”
        </p>
        <div className="flex items-center gap-4">
          <img
            src="/Pawan.jpg"
          ...
          />
          <div className="text-left">
            <h4 className="font-semibold">Pawan Gaha</h4>
            <p className="text-sm text-gray-500">BSc.CSIT, 7th Semester</p>
          </div>
        </div>
      </div>
